    ...
    function weeklyPropublicaUpdate() {
        ...
        function loadNewMembersRequest() {
            return new Promise(function(resolve, reject) {
                var options = {
                    url: 'https://api.propublica.org/congress/v1/members/new.json',
                    headers: {
                      'User-Agent': {'X-API-Key': 'CGreQp3d95C4FLYHkCZRph5Hhs9nqfRCdJNlrxHL'},
                      success: function(response){
                        if (response['results'][0]['members']) {
                            var membersArray = response['results'][0]['members'];
                            resolve(membersArray);
        ...
        function updateNewMembers(newPropublicaMembers) {
            newPropublicaMembers.forEach(function(new_propub_member) {
                ...
                findSpecificMemberRequest(new_propub_member.id).then(function(existing_propub_member) {
        ...
        loadNewMembersRequest().then(function(newMembers) {
...
(function(module) {
    ...
    function loadNewMembersRequest() {
        return new Promise(function(resolve, reject) {
           var options = {
               hostname: 'https://api.propublica.org/congress/v1/members/new.json',
               headers: {
    ...
    var options = {
        hostname: 'https://api.propublica.org/congress/v1/members/' + member_id + '.json',
        headers: {
            'X-API-Key': 'CGreQp3d95C4FLYHkCZRph5Hhs9nqfRCdJNlrxHL'
        },
        method : 'GET'
